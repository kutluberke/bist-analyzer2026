# BIST100 Ticker List — yfinance format (suffix: .IS)
# Sector assignments are approximate and based on primary business activity.
...
BIST_TICKERS: list[dict] = [
    ...
    {"ticker": "QNBFB.IS",  "name": "QNB Finansbank",        "sector": "Bankacılık"},
    ...
    {"ticker": "METUR.IS",  "name": "Metura Enerji",         "sector": "Enerji"},
    ...
    {"ticker": "YMTAS.IS",  "name": "Yibitaş",               "sector": "Otomotiv"},
    ...
    {"ticker": "SAVKK.IS",  "name": "Savunma Teknolojileri", "sector": "Savunma"},
    ...
    {"ticker": "LCAYT.IS",  "name": "LC Waikiki",            "sector": "Perakende"},

    # ── Cam / Çelik ──────────────────────────────────────────────────────────
    {"ticker": "EREGL.IS",  "name": "Ereğli Demir Çelik",   "sector": "Cam/Çelik"},
    {"ticker": "KRDMD.IS",  "name": "Kardemir (D)",          "sector": "Cam/Çelik"},
    {"ticker": "TRKCM.IS",  "name": "Trakya Cam",            "sector": "Cam/Çelik"},
    {"ticker": "ANACM.IS",  "name": "Anadolu Cam",           "sector": "Cam/Çelik"},
    {"ticker": "DENCM.IS",  "name": "Denizli Cam",           "sector": "Cam/Çelik"},
    ...
    # ── İnşaat / GYO ─────────────────────────────────────────────────────────
    {"ticker": "EMLAK.IS",  "name": "Emlak Konut GYO",       "sector": "İnşaat/GYO"},
    {"ticker": "TOBRV.IS",  "name": "Torunlar GYO",          "sector": "İnşaat/GYO"},
    ...
    {"ticker": "GUSGF.IS",  "name": "Güneş Sigorta",         "sector": "Sigorta"},
    ...
    {"ticker": "SELGD.IS",  "name": "Selva Gıda",            "sector": "Gıda"},
    ...
    # ── Madencilik ───────────────────────────────────────────────────────────
    {"ticker": "IPEKE.IS",  "name": "İpek Doğal Enerji",     "sector": "Madencilik"},
    {"ticker": "KOZAL.IS",  "name": "Koza Altın",            "sector": "Madencilik"},
    {"ticker": "KOZAA.IS",  "name": "Koza Anadolu Metal",    "sector": "Madencilik"},
